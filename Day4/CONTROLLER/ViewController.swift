...
class ViewController: UIViewController {
    ...
    override func loadView() {
        ...
        firstView.newLabel.text = "A New System for Medical Students"
        secondView.newLabel.text = "Introducing Omni Connx "
        thirdView.newLabel.text = "Making Work Life Simple"
    ...
    func addGradientToView(view: UIView)
    {
        ...
        //define colors
        gradientLayer.colors = [UIColor.blue.cgColor, UIColor.white.cgColor, UIColor.yellow.cgColor]
